...
import RcCascader from './rc-cascader.jsx';
...
class Cascader extends React.Component {
    ...
    getSelectedOptions() {
        ...
        return arrayTreeFilter(options, (o, level) => o.value === unwrappedValue[level]);
    }

    getLabel() {
        const { options } = this.props;
        const displayRender = this.props.displayRender || defaultDisplayRender;
        const value = this.state.value;
        const unwrappedValue = Array.isArray(value[0]) ? value[0] : value;
    ...
    render() {
        ...
        const {
            prefixCls, inputPrefixCls, children, placeholder, size, disabled, onItemClick,
